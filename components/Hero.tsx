...
export default function Hero({ title, description, services, imageSrc, bgImage, link }: HeroProps) {
  return (
    <section className="w-full rounded-b-[20px]">
      <div className="w-full pb-[200px]">
        <div className="w-full flex flex-col">
          ...
          {/* Description + Services + Visit Link */}
              ...
              <div className="w-[50%] sm:w-full xm:w-full sm:flex-col xm:flex-col flex gap-[20px]">
                ...
                <div className="flex flex-col gap-[10px]">
                  ...
                  <div className="w-fit rounded-[50px] border border-[#212121] cursor-pointer">
                    ...
                    >
                      <Rounded className="py-[3px]" backgroundColor="#000">
                        <p className="z-10 px-[15px]">{services[0]}</p>
                      </Rounded>
                    </Link>
                  </div>
                  ...
                  <a
                    ...
                    className="w-fit px-5 py-2 rounded-[50px] text-xl font-extralight text-[#212121] border border-[#21212155] hover:bg-[#212121] hover:text-white transition-all duration-300 ease-in-out"
                  >
                    Link to Visit
                  </a>
                </div>
