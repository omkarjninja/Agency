...
import { ochiside, Wlogo2 } from "@/public";
...
export default function Hero() {
							...
							<div className="w-[48%] flex justify-between sm:w-full xm:w-full sm:flex-col xm:flex-col gap-[20px]">
								<div className="w-[50%] flex flex-col gap-y-[40px] sm:w-full xm:w-full">
									<div className="flex flex-col gap-y-[20px]">
										...
										At Webonism, the web is our canvas. It&apos;s not
											<br /> just about code—it’s our philosophy.
											<br />
											We believe that a well-crafted website 
											<br /> speaks louder than words, turning ideas into<br />
									...
									<div className="flex flex-col gap-y-[20px]">
									<p className="paragraph font-NeueMontreal text-secondry">
    We believe a great website captivates,  
    <br /> engages, and drives business growth  
    <br /> better than words alone. That’s why we  
    <br /> founded Webonism—to help brands  
    <br /> stand out with stunning, high-performing  
    <br /> digital experiences.  
			...
			<div className="padding-x">
				...
				We rescue brands from outdated and 
					<br className="sm:hidden xm:hidden" /> underperforming websites.
				</h1>
			</div>
		</section>
	);
