...
export default function About() {
    ...
    A team of designers, developers, and  
    <br /> innovators who collaborate to craft  
    <br /> game-changing websites that captivate,  
    <br /> engage, and drive real business growth.  
</p>
								</div>
								<div className="flex flex-col gap-y-[20px]">
								<p className="paragraph font-NeueMontreal text-secondry">  
    And we strive to become one of the most  
    <br /> recognized & influential web agencies  
    <br /> of our time, crafting digital experiences  
    <br /> that leave a lasting impact.  
</p>
